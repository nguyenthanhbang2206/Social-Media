...
package com.nguyenthanhbang.Social_media.util;
...
public class SecurityUtil {
    ...
    public String createAccessToken(String email, AuthenticationResponse authenticationResponse) {
        ...
        JwtClaimsSet claims = JwtClaimsSet.builder()
                ...
                .subject(email)
                .claim("role", role)
            .claim("userId", authenticationResponse.getUser().getId())
                .build();
    ...
    public static Optional<String> getCurrentUserLogin() {
        Optional<String> headerEmail = RequestHeaderUtil.getUserEmail();
